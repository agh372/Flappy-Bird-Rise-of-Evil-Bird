...
public class ScrollingScript : MonoBehaviour
{
	...
	void Start()
	{
		...
		GameController.GetInstance.deathEvent += OnPlayerDeath; //registering to the event
	...
	void Update()
	{
            ...
            else
            {
                ...
                //If not looping, we dont need it after it crosses the left side of the camera, hence it must be deleted 
                //to free the memory
	...
	public void IncrementVelocity(){
		//speed = speed + new Vector2(0.2f, 0);
